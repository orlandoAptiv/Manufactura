...
public class CapturaExcelGSD_Verdadero extends javax.swing.JFrame {
    ...
    DefaultTableModel modelo;
     public CapturaExcelGSD_Verdadero() {
        initComponents();
     ...
     public void EnlazarDgv(String Plataforma, String Arnes, String Cad1, String Cad2, String Cad3, String Cad4, String Cad5,String Cad6,String Cad8, String Codigo, String Turno){
        try {
            ...
            modelo.setColumnIdentifiers(new Object[]{"IDENT", "PLAT.",  "CODIGO", "LINEA", "TURNO", "POND.CORTE", "POND.LPS", "POND.EF.","SALIDAPZA", "GSCD CORTE", "GSCD LPS", "GCSD E.F"});
            ...
            String query="SELECT\n" +
                    ...
                    "c.TURNO,\n" +
                    "g.HCDIRCORTE, g.HCDIRLPS, g.HCDIRENSFINAL,M.SALIDAENPIEZA,\n" +
                   
                    "IF(c.TURNO='A',TRUNCATE(((g.HCDIRCORTE*m.SALIDAENPIEZA)/100)/9,2) ,TRUNCATE(((g.HCDIRCORTE*m.SALIDAENPIEZA)/100)/7.9,2))AS GSCD_CORTE,\n" +
                    "IF(c.TURNO='A',TRUNCATE(((g.HCDIRLPS*m.SALIDAENPIEZA)/100)/9,2) ,TRUNCATE(((g.HCDIRLPS*m.SALIDAENPIEZA)/100)/7.9,2))AS GSCD_LPS,\n" +
                    "IF(c.TURNO='A',TRUNCATE(((g.HCDIRENSFINAL*m.SALIDAENPIEZA)/100)/9,2) ,TRUNCATE(((g.HCDIRENSFINAL*m.SALIDAENPIEZA)/100)/7.9,2))AS GSCD_EF FROM\n" +
                    "(select * from codigos";
            ...
            while(rs.next())
            {
               modelo.addRow(new Object[]{rs.getString("idcodigo"), rs.getString("PLATAFORMA"), rs.getString("codigo"), rs.getString("LINEA"), rs.getString("turno"),  rs.getString("HCDIRCORTE"), rs.getString("HCDIRLPS"), rs.getString("HCDIRENSFINAL"),rs.getString("SALIDAENPIEZA"),rs.getString( "GSCD_CORTE"), rs.getString("GSCD_LPS"),rs.getString("GSCD_EF") });
            }
...
//              tblCodigos.getColumnModel().getColumn(5).setPreferredWidth(50);  
    ...
    private void btnImportar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportar1ActionPerformed
        // TODO add your handling code here:
         try{
           EXCELGCSD exportar=new EXCELGCSD((DefaultTableModel)tblCodigos.getModel(), "Reporte ");
       }catch(Exception e )
       {
           System.out.println(e.toString());
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturaExcelGSD_Verdadero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturaExcelGSD_Verdadero().setVisible(true);
            }
        });
    }
