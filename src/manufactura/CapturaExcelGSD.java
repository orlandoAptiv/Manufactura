    ...
    DefaultTableModel modelo;
     ...
     public void EnlazarDgv(String Plataforma, String Arnes, String Cad1, String Cad2, String Cad3, String Cad4, String Cad5,String Cad6, String Codigo, String Turno){
        try {
            ...
            modelo.setColumnIdentifiers(new Object[]{"IDENT", "PLAT.",  "CODIGO", "LINEA", "TURNO", "POND.CORTE", "POND.LPS", "POND.EF.","HC", "PZAS."});
            ...
            String query="SELECT\n" +
                    ...
                    "(m.elinea+estaciones+ m.kits+m.HCDIRLINEA+ m.hcdirconte+m.HCDIRSOPORTE+m.HCDIRTABINSP+m.hcrutasint+m.hcdirlps+m.HCDIRSOPLPS+ m.hcdirpilotos+m.hcdirftq+ m.hcdirsistemas)as HC,m.SALIDAENPIEZA as PZAS from\n" +
                    "(select * from codigos";
            ...
            query+=") as c,\n" +
                    ...
                    "c.IDCODIGO = g.IDCODIGO  and m.idcodigo=c.idcodigo and m.activo=1 ORDER BY c.linea, c.turno ";
            ...
            while(rs.next())
            {
               modelo.addRow(new Object[]{rs.getString("idcodigo"), rs.getString("PLATAFORMA"), rs.getString("codigo"), rs.getString("LINEA"), rs.getString("turno"),  rs.getString("HCDIRCORTE"), rs.getString("HCDIRLPS"), rs.getString("HCDIRENSFINAL"), rs.getString("HC") , rs.getString("PZAS")  });
            }
...
//              tblCodigos.getColumnModel().getColumn(5).setPreferredWidth(50);  
    ...
    private void btnImportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportarActionPerformed
        // TODO add your handling code here:
        this.hide();
        LectorGSDExcel LGSDE=new LectorGSDExcel();
        LGSDE.setVisible(true);
        LGSDE.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturaExcelGSD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturaExcelGSD().setVisible(true);
            }
        });
    }
