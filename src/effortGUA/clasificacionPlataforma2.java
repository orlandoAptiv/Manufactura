...
public class clasificacionPlataforma2 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form clasificacionPlataforma2
     */
    public clasificacionPlataforma2() {
        try {
            initComponents();
            setLocationRelativeTo(null);
//            Principal.cn=new Conection();
            enlazartablaDisp("TODOS", "TODOS");
            EnlazarTablaClasificacion("25986");
            
        } catch (Exception ex) {
            Logger.getLogger(clasificacionPlataforma2.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
...
//              query+=" ";
    ...
    private void initComponents() {
        ...
        cbxDepto.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25986" }));
        ...
        cbxCadena.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TODOS", "1", "2", "3", "4", "6" }));
...
//            lista.add(cbxDepto.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clasificacionPlataforma2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clasificacionPlataforma2().setVisible(true);
            }
        });
    }
