...
public class CapturaPorcentajesEffort2 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CapturaPorcentajesEffort2
     */
    public CapturaPorcentajesEffort2() {
        try {
            initComponents();
...
//      if((cbxModuloAlta.getSelectedItem()!=null) || )
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturaPorcentajesEffort2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturaPorcentajesEffort2().setVisible(true);
            }
        });
    }
