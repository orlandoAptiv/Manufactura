 ...
 * @author Felipe M
 */
public class cablesBateria2 extends javax.swing.JFrame {

    /**
     * Creates new form cablesBateria2
     */
    public cablesBateria2() {
        try {
            initComponents();
//            Principal.cn=new Conection();
            ...
            Logger.getLogger(cablesBateria2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cablesBateria2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cablesBateria2().setVisible(true);
            }
        });
    }
